...
const parent = this.closest(".mini-info");
...
addBtn.textContent = `ADD TO BAG — ${price} BD`;

});
});
/* MINI GLOW PRICE SELECT */

const miniCards = document.querySelectorAll(".mini-info");

miniCards.forEach(card => {

const buttons = card.querySelectorAll(".size-btn");
const priceBox = card.querySelector(".selected-price");
