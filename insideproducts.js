...
const productMain = document.querySelector(".product-img-main");
const productHover = document.querySelector(".product-img-hover");

if(productMain && productHover){

productMain.addEventListener("mouseenter",function(){

productMain.style.opacity = "0";
productHover.style.opacity = "1";

});

productMain.addEventListener("mouseleave",function(){

productMain.style.opacity = "1";
productHover.style.opacity = "0";
...
const shadeSelect = document.querySelector(".product-shades");

if(shadeSelect){

shadeSelect.addEventListener("change",function(){

console.log("Selected shade:",this.value);
